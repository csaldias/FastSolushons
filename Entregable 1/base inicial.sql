...
INSERT INTO `cat-mat` VALUES (1,1,1),(2,1,2),(3,2,3),(4,2,4),(5,3,1),(6,3,4),(7,4,3),(8,4,2);
...
INSERT INTO `categoria` VALUES (1,'Asimilador'),(2,'Convergente'),(3,'Divergente'),(4,'Adaptador');
...
LOCK TABLES `profesor_admin` WRITE;
/*!40000 ALTER TABLE `profesor_admin` DISABLE KEYS */;
INSERT INTO `profesor_admin` VALUES (1,'maxi','maxi1','1234','max@max.cl',1),(2,'carlos','carlos','1234','carlos@car.cl',1),(3,'camilo','camilo','1234','camilo@cam.cl',1),(4,'nacho','nacho','1234','nacho@nat.cl',1),(5,'profe','profe','1234','profe@pro.cl',0),(6,'profe2','profe2','1234','profe2@pro.cl',0);
/*!40000 ALTER TABLE `profesor_admin` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-09-10  1:55:56
